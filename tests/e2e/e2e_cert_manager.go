...
var _ = Describe("e2e cert-manager", func() {
	...
	BeforeEach(func() {
		By("Waiting to cert-manager's pods ready")
		...
		By("creating certs and issuer objects")
	...
	var _ = Describe("--> Issuers", func() {
		...
		It("should Issuer exists in namespace cert-manager-local-ca", func() {
		...
		It("should Issuer be in ready in namespace cert-manager-local-ca", func() {
		...
		It("should Issuer exists in namespace cert-manager-local-ca2", func() {
		...
		It("should Issuer be in ready in namespace cert-manager-local-ca2", func() {
			By("Waiting for Issuer to become Ready")
	...
	var _ = Describe("--> Certificates/Secrets", func() {
		It("should provide cert-key for cert-manager-local-ca", func() {
		...
		It("should provide cert-key for cert-manager-local-ca2", func() {
